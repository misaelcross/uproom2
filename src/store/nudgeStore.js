  ...
  nudges: [
    {
      ...
      message: 'Hi @Sarah Johnson! Could you review the document I sent yesterday? I need your feedback by tomorrow morning to finalize the presentation. Also, please loop in @Marcus Chen for the technical review.',
      fullMessage: 'Hi @Sarah Johnson! Could you review the document I sent yesterday? I need your feedback by tomorrow morning to finalize the presentation. Also, please loop in @Marcus Chen for the technical review. Thanks!',
      timestamp: '2h',
      type: 'message',
      priority: 'high',
      isRead: false,
